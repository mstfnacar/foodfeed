...
public class FavoritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerLayout = (CoordinatorLayout) findViewById(R.id.favoritesrecyclerlayout);
        recyclerLayout.setVisibility(View.GONE);

        applicationContext = this.getApplicationContext();

        progressWheel = (LinearLayout) findViewById(R.id.favoritesprogresswheel);
        progressWheel.setVisibility(View.VISIBLE);
        //wheel.setBarColor(Color.BLUE);

        mRecyclerView = (RecyclerView) findViewById(R.id.favoritesRecyclerView);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.favoritesswiperefresh);
    ...
    private void getDataSet() {
        ...
        String url = "http://" + serverAddress + "/followingposts/?username="+ LoginState.getUserInfo(applicationContext) +"&client_type="+clientType;
        ...
        Volley.newRequestQueue(FavoritesActivity.this).add(jsonRequest);
        //return results;
    }
